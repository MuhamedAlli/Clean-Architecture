...
mixin _$RegisterObject {
  ...
  String get password => throw _privateConstructorUsedError;
  String get profilPicture => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      password: null == password
          ...
          : password // ignore: cast_nullable_to_non_nullable
              as String,
      profilPicture: null == profilPicture
          ? _value.profilPicture
          : profilPicture // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.countryMobileCode, this.mobileNumber,
      this.email, this.password, this.profilPicture);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryMobileCode: $countryMobileCode, mobileNumber: $mobileNumber, email: $email, password: $password, profilPicture: $profilPicture)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.password, password) ||
                other.password == password) &&
            (identical(other.profilPicture, profilPicture) ||
                other.profilPicture == profilPicture));
  }

  @override
  int get hashCode => Object.hash(runtimeType, userName, countryMobileCode,
      mobileNumber, email, password, profilPicture);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String email,
      final String password,
      final String profilPicture) = _$_RegisterObject;
